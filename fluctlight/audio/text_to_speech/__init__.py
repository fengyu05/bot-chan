...
from fluctlight.settings import TTS_ENGINE
...
def get_text_to_speech(tts: str | None = None) -> TextToSpeech:
    ...
    if tts == "ELEVEN_LABS":
        ...
        from fluctlight.audio.text_to_speech.google_cloud_tts import GoogleCloudTTS

        GoogleCloudTTS.initialize()
        return GoogleCloudTTS.get_instance()
    elif tts == "XTTS":
        from fluctlight.audio.text_to_speech.xtts import XTTS
